<template>
  <div>
    ...
    <el-table style="width: 100%" border :data="records">
      ...
      <el-table-column prop="skuDesc" label="描述" width="90">
      </el-table-column>
      ...
      <el-table-column prop="prop" label="操作" width="width">
        <template slot-scope="{row}">
          ...
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="editmess"></el-button>
    ...
    <el-drawer :visible.sync="drawer" :direction="direction" :show-close="false" size="50%">
      ...
      <el-row>
        ...
        <el-col :span="16">
          <template>
            <el-tag type="success" v-for="(attr) in skuInfo.skuAttrValueList" :key="attr.id" style="margin:5px 8px">{{attr.attrId}}-{{attr.valueId}}</el-tag>
          </template>
        </el-col>
      </el-row>
      <el-row>
